  ...
  return (
    <div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-11/12 md:w-auto md:max-w-7xl mx-auto py-8 border-b border-b-primary">
        <nav className="space-y-2">
          ...
          <p className="lg:max-w-xs">
            FastDelivery Industry <br /> Providing reliable tech since 2010.
            It's a large Industry where our consumer can transport <br />
      ...
      <footer className="footer sm:footer-horizontal footer-center bg-base-300 text-base-content p-4">
        <aside>
          <p>
            Copyright © {new Date().getFullYear()} - All right reserved by Fast Delivery
          </p>
        </aside>
      </footer>
    </div>

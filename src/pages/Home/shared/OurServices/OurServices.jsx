...
const OurServices = () => {
  const services = [
    ...
    },
    {
      ...
      description:
        "Customized service with comprehensive inventory management support.",
      features: [
    ...
    },
    {
      ...
      description:
        "Customized corporate services with comprehensive logistics support.",
      features: [
    ...
    },
    {
      ...
      title: "Parcel Return",
      description:
        "Reverse logistics facility for returns and exchanges with online merchants.",
      features: [
        "Reverse logistics",
        "Product returns",
        "Exchange facility",
        ...
        <div className="text-center">
          <div className="bg-gradient-to-tl from-primary to-secondary text-primary-content p-8 rounded-2xl shadow-2xl">
            ...
            <p className="text-lg mb-6 opacity-90 max-w-2xl mx-auto">
              Join thousands of satisfied customers and businesses who trust us
              with their deliveries across Bangladesh.
            </p>
